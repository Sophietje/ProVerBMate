...
public class ToolMDParser {
    public static MDTool read(File input){
    ...
    static String memory; //Remember what you've read if it was not supposed to be a part of this section
    public static List<String> readSection(BufferedReader br) throws IOException{
        memory = null;
